    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="订单号" prop="odd">
                              <el-input v-model="ruleForm.odd"
                                        placeholder="订单号" clearable></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="订单号" prop="odd">
                                  <el-input v-model="ruleForm.odd"
                   ...
                   <el-col :span="12">
                      ...
                      <el-col :span="12">
                          <el-form-item class="input" v-if="type!='info'" label="数量" prop="number">
                              <el-input v-model="ruleForm.number" type="number"
                                        placeholder="数量"></el-input>
                          </el-form-item>
                          <div v-else>
                              <el-form-item class="input" label="数量" prop="number">
                         ...
                         <el-col :span="12">
                             <el-form-item class="input" v-if="type!='info'" type="number" label="单价" prop="money">
                                 <el-input v-model="ruleForm.money" type="number"
                                           placeholder="单价"></el-input>
                             </el-form-item>
                             <div v-else>
                                 <el-form-item class="input" label="单价" prop="money">
        ...
        methods: {
            ...
            init(id,type) {
                ...
                this.$http({
                    ...
                    this.$message.error(data.msg);
                       ...
                       /* 查询海鲜名称信息*/
                    this.$http({
                        url: `dictionary/page?page=1&limit=100&sort=&order=&dicCode=hx_types`,
                        method: "get"
                    }).then(({data}) => {
                        if (data && data.code === 0) {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url: `dingdanxiangqing/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
