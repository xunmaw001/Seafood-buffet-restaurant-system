    ...
    export default {
        ...
        methods: {
            ...
            getDataList() {
				...
				if(this.$route.query.odd!='' && this.$route.query.odd!=undefined){
					params['odd'] = this.$route.query.odd
				}
